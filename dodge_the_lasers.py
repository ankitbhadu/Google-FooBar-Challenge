...
def solution(n):
    ...
    if(x<1):
        return 0
    y=int((4142135623730950488016887242096980785696718753769480731766797379907324784621070388503875343276415727-1)*x)//10**100
    ans= x*(y)+(x*(x+1))//2-(y*(y+1))//2-int(solution(y))
    return str(ans)
